...
//     });
//
//     const arr = remoteDataSource.load()
//
//     const arrS = arr
...
//     }
//
//     const test = Promise.resolve(arrS).then(d=>ex(d))
//
//     //console.log('ds - ',arr, Object.keys(arr)).resolveArgs()
//     console.log('ds - ', arrS, arr, Object.keys(arr))
//     console.log(arrS)
//
//     return (
//         <div id="data-grid-demo">
